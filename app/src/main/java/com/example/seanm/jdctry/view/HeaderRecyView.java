...
import com.example.seanm.jdctry.pullrecy.indicator.PtrIndicator;
import com.example.seanm.jdctry.pullrecy.indicator.PtrUIHandler;

/**
 * Created by SeanM on 2017/11/1.
 */

public class HeaderRecyView extends PtrFrameLayout implements PtrUIHandler {
    ...
    public HeaderRecyView(Context context) {
        super(context);
        initView();
    }

    public HeaderRecyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public HeaderRecyView(Context context, AttributeSet attrs, int defStyle) {
